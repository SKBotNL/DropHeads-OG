...
public final class TextureKeyLookup{
	...
	public static String getTextureKey(Entity entity){
		...
		case "RABBIT":
			if(entity.customName() != null && entity.customName().examinableName().equals("Toast")) return "RABBIT|TOAST";
			return "RABBIT|"+((Rabbit)entity).getRabbitType().name();
		case "SHEEP":
			if(entity.customName() != null && entity.customName().examinableName().equals("jeb_")) return "SHEEP|JEB";
		...
		case "OCELOT": {
			if (entity instanceof Ocelot) {
				// Ocelots no longer have types, they are simply wild ocelots.
				return "OCELOT";
			}
		}
		case "CAT": {
